...
DEBUG = True  # For development mode, set it to True

ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # It's a good practice to include this
...
INSTALLED_APPS = [
    ...
    'player_stats',  # Register the app here
]
